          ...
          <header id="page-header" className="flex flex-none items-center bg-white py-10">
            <div className="flex flex-col text-center md:flex-row md:items-center md:justify-between space-y-6 md:space-y-0 container xl:max-w-7xl mx-auto px-4 lg:px-8">
              ...
              {/* <Link to="/blog">Blog</Link> */}
                ...
                <Link to="/" className="inline-flex items-center space-x-2 font-bold text-lg tracking-wide text-indigo-600 hover:text-indigo-400">
              ...
              <div className="flex flex-col text-center md:flex-row md:items-center md:justify-between space-y-6 md:space-y-0 md:space-x-10">
                <nav className="space-x-4 md:space-x-6">
                  <Link to="/feature" className="font-semibold text-gray-900 hover:text-gray-500">
                    <span>Features</span>
                  </Link>
                  <Link to="/plans" className="font-semibold text-gray-900 hover:text-gray-500">
                    <span>Plans</span>
                  </Link>
                  <Link to="/about" className="font-semibold text-gray-900 hover:text-gray-500">
                    <span>About</span>
                  </Link>
                </nav>
